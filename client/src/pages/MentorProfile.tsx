...
import { UserCircle, Pencil, Check, Loader2, Mail, Shield } from "lucide-react";
...
export default function MentorProfile() {
  ...
  // Guard: only mentors can access this page
  if (!isLoading && user && user.roleId !== ROLE_IDS.MENTOR) {
