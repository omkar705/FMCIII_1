  ...
  return (
    <Shell>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
          <h1 className="text-4xl font-display font-bold mb-2">Knowledge Base</h1>
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          ...
          <DialogContent className="bg-white border-gray-200 shadow-xl max-w-2xl">
            <DialogHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 mt-4">
              <div className="space-y-2">
                ...
                <Input name="title" required className="bg-white border-gray-200 font-medium" placeholder="e.g. How to prepare for Series A" />
              </div>
              <div className="space-y-2">
                <Label className="text-foreground">Content</Label>
                <Textarea name="content" required className="bg-white border-gray-200 min-h-[200px] font-sans" placeholder="Write article content here..." />
              </div>
      ...
      {kLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {articles?.map(article => (
            <Card key={article.id} className="p-6 border-gray-200 bg-white shadow-sm hover-elevate">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex justify-between items-center text-xs text-muted-foreground/70 pt-4 border-t border-gray-200">
